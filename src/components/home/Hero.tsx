            ...
            <div className='container h-full p-4 mx-auto flex justify-between items-center relative'>
                ...
                <div className='flex gap-x-10'>
                    ...
                    <div className='hidden md:block horizontal-line'>
                        ...
                        <ul className='flex flex-col gap-y-8'>
                            ...
                            <li>
                                ...
                                <a className='text-gray-300 text-lg hover:opacity-80 transition duration-300 ease-in-out' href='https://github.com/ZohirEDDIG'>
                            ...
                            <li>
                                ...
                                <a className='text-gray-300 text-lg hover:opacity-80 transition duration-300 ease-in-out' href='https://www.linkedin.com/in/zohir-eddig-628669317'>
                            ...
                            <li>
                                ...
                                <a className='text-gray-300 text-lg hover:opacity-80 transition duration-300 ease-in-out' href='https://x.com/zohireddig'>
                            ...
                            <li>
                                ...
                                <a className='text-gray-300 text-lg hover:opacity-80 transition duration-300 ease-in-out' href='mailto:zohireddig.dev@gmail.com'>
                    ...
                    <div className='flex gap-y-2.5 flex-col'>
                        ...
                        <button className='text-secondary w-fit px-4 py-2 mt-2.5 border border-secondary flex items-center gap-x-2 cursor-pointer select-none hover:opacity-80 transition duration-300 ease-in-out' type='button'>
