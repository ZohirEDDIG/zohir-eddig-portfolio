...
const EducationCard = ({ education, direction }: Props) => {
    return (
        <div 
            ...
            >
                ...
                <div className='flex flex-col gap-y-2'>
                    ...
                    <div className='flex flex-col sm:flex-row lg:flex-col xl:flex-row sm:items-center lg:items-start xl:items-center'>
                        ...
                        <span className='text-secondary text-sm'>{education.place}</span>

                        <Dot className='text-secondary hidden sm:block lg:hidden xl:block' />

                        <span className='text-secondary text-sm'>{education.duration}</span>

                    </div>

                    <h2 className='text-white italic line-clamp-1'>{education.name}</h2>

                    <p className='text-gray-300 text-sm line-clamp-2'>{education.description}</p>
